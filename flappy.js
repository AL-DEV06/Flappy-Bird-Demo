...
window.onload = function () {
    ...
    setInterval(placePipes, 1800);//every 1.8 seconds the pipes are replaced
...
function update() {
    ...
    context.drawImage(birdImg[birdImgsIndex], bird.x, bird.y, bird.width, bird.height);
    birdImgsIndex++; //increments to frames
    ...
    if (gameOver) {
        context.fillText("UR BUNZ", 5, 635);
